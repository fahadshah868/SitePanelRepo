    ...
    $(".multiselectdropdown").multiselect({
      nonSelectedText: 'Selected None',
        ...
        templates: {
                        ...
                        button: '<button type="button" class="multiselect dropdown-toggle" data-toggle="dropdown" data-flip="false" style="color: #000; text-align: left;"><span class="multiselect-selected-text"></span> <b class="caret"></b></button>',
