    ...
    $(document).ready(function(){
        ...
        $("#addeventform").submit(function(event){
            ...
            submitHandler: function(form) {
                ...
                var _jsondata = JSON.stringify({eventtitle: _eventtitle, displayinfooter: _displayinfooter, eventdescription: _eventdescription, iseventready: _iseventready, eventstatus: _eventstatus, _token: '{{ csrf_token() }}'});
