    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-field">
                ...
                <input type="text" class="form-control form-field-text active-item" value="_{{ $blogcategory->status }}" readonly/>
                @else
                <input type="text" class="form-control form-field-text deactive-item" value="{{ $blogcategory->status }}" readonly/>
                @endif
            </div>
        </div>
    </div>
