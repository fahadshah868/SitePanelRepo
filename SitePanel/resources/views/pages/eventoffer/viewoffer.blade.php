    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="form-field">
                ...
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->store->title }}" readonly/>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-field">
                <div class="form-field-heading">Category Title</div>
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->category->title }}" readonly/>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
            <div class="form-field">
                ...
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->title }}" readonly/>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-field">
                <div class="form-field-heading">Offer Anchor</div>
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->anchor }}" readonly/>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-3">
            <div class="form-field">
                ...
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->location }}" readonly/>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-field">
                <div class="form-field-heading">Offer Type</div>
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->type }}" readonly/>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-field">
                ...
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->code }}" readonly/>
            </div>
        </div>
        @else
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-field">
                ...
                <textarea class="form-control form-field-textarea" readonly>{{$eventoffer->offer->details}}</textarea>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-3">
            <div class="form-field">
                ...
                <input type="text" class="form-control form-field-text" value="{{Carbon\Carbon::parse($eventoffer->offer->starting_date)->format('d-m-Y')}}" readonly>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-field">
                ...
                <input type="text" class="form-control form-field-text" value="{{ \Carbon\Carbon::parse($eventoffer->offer->expiry_date)->format('d-m-Y') }}" readonly/>
                @else
    ...
    <div class="row">
        <div class="col-sm-2">
            <div class="form-field">
                ...
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->is_popular }}" readonly/>
            </div>
        </div>
        <div class="col-sm-2">
            <div class="form-field">
                <div class="form-field-heading">Display At Home</div>
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->display_at_home }}" readonly/>
            </div>
        </div>
        <div class="col-sm-2">
            <div class="form-field">
                <div class="form-field-heading">Is Verified Offer</div>
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->is_verified }}" readonly/>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-field">
                <div class="form-field-heading">Offer Status</div>
                @if($eventoffer->offer->is_active == "y")
        ...
        <div class="col-sm-3">
            <div class="form-field">
                ...
                <input type="text" class="form-control form-field-text" value="{{ $eventoffer->offer->user->username }}" readonly/>
            </div>
        </div>
    </div>
    <div class="row">
